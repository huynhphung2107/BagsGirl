...
function FormBuckleTypeCreate(props) {
    ...
    return (
        <Fragment>
            <Button type="primary" onClick={showComponent} icon={<PlusOutlined />}> Thêm kiểu khóa</Button>
            <br />
            <Modal title="Thêm kiểu khóa" open={openComponent} onCancel={closeComponent} footer={null}>
                <div>
                    ...
                    >
                        <Form.Item label="Tên kiểu khóa" name="buckleTypeName"
                            rules={[
                                {
                                    required: true,
                        ...
                        <Form.Item label="Trạng thái" name="buckleTypeStatus"
                            rules={[
                                {
                                    required: true,
