...
function FormProducerCreate(props) {
    ...
    return (
        <Fragment>
            <Button type="primary" onClick={showComponent} icon={<PlusOutlined />}> Thêm nhà sản xuất</Button>
            <br />
            <Modal title="Thêm nhà sản xuất" open={openComponent} onCancel={closeComponent} footer={null}>
                <div>
                    ...
                    >
                        <Form.Item label="Tên nhà sản xuất" name="producerName"
                            rules={[
                                {
                                    required: true,
                        ...
                        <Form.Item label="Trạng thái" name="producerStatus"
                            rules={[
                                {
                                    required: true,
