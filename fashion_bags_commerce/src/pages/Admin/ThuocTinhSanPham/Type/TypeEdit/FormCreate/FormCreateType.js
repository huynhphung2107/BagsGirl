...
function FormTypeCreate(props) {
    ...
    return (
        <Fragment>
            <Button type="primary" onClick={showComponent} icon={<PlusOutlined />}> Thêm kiểu balo</Button>
            <br />
            <Modal title="Thêm kiểu balo" open={openComponent} onCancel={handleCancel} footer={null}>
                <div>
                    ...
                    >
                        <Form.Item label="Tên kiểu" name="typeName"
                            rules={[
                                {
                                    required: true,
                        ...
                        <Form.Item label="Trạng thái" name="typeStatus"
                            rules={[
                                {
                                    required: true,
